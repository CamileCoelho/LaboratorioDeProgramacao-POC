...
namespace LaboratorioDeProgramacao.WinApp.ModuloDisciplina
{
    public partial class TelaDisciplinaForm : Form
    {
        ...
        {
            labelDisciplina.Text = TelaPrincipalForm.translationService.ObterTexto("Discipline") + ":";
            btnGravar.Text = TelaPrincipalForm.translationService.ObterTexto("Save");
            btnCancelar.Text = TelaPrincipalForm.translationService.ObterTexto("Cancel");
        }
